...
export const EditorDashboard = () => {
  const [selectedArticleForCorrection, setSelectedArticleForCorrection] =
    useState<any>(null);
  ...
  return (
    <div className="space-y-8">
      ...
      {isLoading ? (
        ...
        <Card className="text-center py-12 border-dashed">
          <CardContent>
            ...
            <p className="text-muted-foreground">
              No articles pending editorial review.
            </p>
          </CardContent>
        </Card>
      ) : (
          ...
          {articles.map((article: any) => (
            ...
            >
              ...
              <CardFooter className="gap-2">
                ...
                <Button
                  variant="ghost"
                  onClick={() => setSelectedArticleForCorrection(article)}
                >
                  <Edit3 className="h-4 w-4 mr-2" /> Correct
                </Button>
              </CardFooter>
            </Card>
          ))}
      ...
      {selectedArticleForCorrection && (
        <CorrectionModal
          article={selectedArticleForCorrection}
          onClose={() => setSelectedArticleForCorrection(null)}
        />
      )}
        ...
        <DialogContent className="flex flex-col !max-w-5xl w-full">
          <DialogHeader>
            <DialogTitle className="font-serif text-2xl">
              {viewingArticle?.headline}
            </DialogTitle>
            <DialogDescription>
              By {viewingArticle?.author.name} • {viewingArticle?.location}
            </DialogDescription>
          </DialogHeader>
          <ScrollArea className="pr-4 h-[50vh]">
            <div
              ...
              dangerouslySetInnerHTML={{
                __html: DOMPurify.sanitize(viewingArticle?.body || ""),
              }}
            />
          </ScrollArea>
